        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + 'books/' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    (book.price ? '<span class="Card-priceOld">' + book.price + 'тг</span>\n' : '') + '                       <span class="Card-price">' + book.discountPrice + 'тг</span>\n' + '                </div>\n' + '              </div>\n' + '            </div>';
            }
            return {
                init: function () {
            ...
            return {
                init: function () {
                    ...
                    $('#submitPhone').on('click', function () {
                        ...
                        postData('/requestPhoneContactConfirmation', data, function (result) {
                            if (result.result) {
